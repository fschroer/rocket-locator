/**
  ******************************************************************************
  * @file    NucleoRadio.h
  * @author  Frank Schroer
  * @brief   Header for NucleoRadio.c
  ******************************************************************************
  */

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef ROCKET_INC_NUCLEORADIO_H_
#define ROCKET_INC_NUCLEORADIO_H_
...
#define RF_SW_CTRL_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOA_CLK_ENABLE()
#define RF_SW_CTRL_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOA_CLK_DISABLE()
...
#endif /* ROCKET_INC_NUCLEORADIO_H_ */
