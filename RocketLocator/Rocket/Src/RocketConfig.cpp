...
void RocketConfig::ProcessChar(UART_HandleTypeDef *huart2, uint8_t uart_char){
	...
	case ConfigState::kWaitingForConfigCommand:
		...
		case 13: // Enter key
			if (StrCmp(user_input_, config_command_, char_pos)){
				*device_state_ = DeviceState::kConfig;
				config_state_ = ConfigState::kConfigHome;
	...
	case ConfigState::kConfigHome:
		...
		case 13: // Enter key
			...
			*device_state_ = DeviceState::kConfigSavePending;
			config_state_ = ConfigState::kWaitingForConfigCommand;
		...
		case 49: // 1 = Edit deploy mode
			config_state_ = ConfigState::kEditDeployMode;
		...
		case 50: // 2 = Edit launch detect altitude
			config_state_ = ConfigState::kEditLaunchDetectAltitude;
		...
		case 51: // 3 = Edit drogue primary deploy delay
			config_state_ = ConfigState::kEditDroguePrimaryDeployDelay;
		...
		case 52: // 4 = Edit drogue backup deploy delay
			config_state_ = ConfigState::kEditDrogueBackupDeployDelay;
		...
		case 53: // 5 = Edit main primary deploy altitude
			config_state_ = ConfigState::kEditMainPrimaryDeployAltitude;
		...
		case 54: // 6 = Edit main backup deploy altitude
			config_state_ = ConfigState::kEditMainBackupDeployAltitude;
		...
		case 55: // 7 = Edit deploy signal duration
			config_state_ = ConfigState::kEditDeploySignalDuration;
		...
		case 56: // 8 = Edit LoRa channel
			config_state_ = ConfigState::kEditLoraChannel;
		...
		break;
	case ConfigState::kEditDeployMode:
		switch (uart_char){
		case 13: // Enter key
			config_state_ = ConfigState::kConfigHome;
			DisplayConfigSettings(huart2);
...
void RocketConfig::DisplayConfigSettings(UART_HandleTypeDef *huart2){
	int uart_line_len = 0;
